...
train_dataset = MNIST(root = 'data/', download = False, train = True, transform = transforms)
test_dataset = MNIST(root = 'data/', download = False, train = False, transform = transforms)
...
FILE_TO_WRITE = "centralizedLearningTests/MNIST.csv"
