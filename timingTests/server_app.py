...
def main(grid: Grid, context: Context) -> None:
    ...
    strategy: NRFLStrategy = NRFLStrategy(fraction_evaluate = fraction_evaluate, fraction_malicious = fraction_malicious, use_dp = use_dp, noise_reduction = noise_reduction, num_updates = num_model_updates)
    ...
    if util.read_toml("measure-messages"):
        with open("message-sizes.txt", 'a') as f:
            f.write(str(strategy.total_message_size/(num_clients*num_model_updates)) + '\n')
